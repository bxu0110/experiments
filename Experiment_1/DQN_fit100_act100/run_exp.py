...
batch_size = 64
learning_rate = 1e-3
log_interval = 200  # (200*125 = 0..25,000)

num_eval_episodes = 10
eval_interval = 500  # (500*50 = 25,000)

# Creating environments
environment = Env_Fit100_Act100(func_num, dim=dim, minimum=fDeltas[func_num-1])
